...
public class Test 
{
	public static void main(String[] args) throws Exception
	{
		...
		//Enter color name from kayboard
		Scanner sc=new Scanner(System.in);
		System.out.println("Enter Expected Color's Red value in RGB");
		int r=sc.nextInt();
		System.out.println("Enter expected color's green value is RGB");
		int g=sc.nextInt();
		System.out.println("Enter expected color's blue value is RGB");
		int b=sc.nextInt();
		...
		try
		{
			WebElement e2=driver.findElement(By.id("results01"));
			...
			File src=driver.findElement(By.id("results01")).getScreenshotAs(OutputType.FILE);
